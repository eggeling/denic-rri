...
<div class="_body">
    ...
    <?php
    $valid_code = 'true';
    if (($_POST['dm_domain'] != "") && ($_POST['dm_domain_ace'] != "")) {
        echo "No data or forbidden char in fields domain and domain-ace!<br>";
        $valid_code = 'false';
    }
    if (!preg_match("=[A-Za-z0-9-\.]+$=i", $_POST['dm_domain']) && ($_POST['dm_domain'] != "")) {
    ...
    if (!preg_match("=[A-Za-z0-9-\.]+$=i", $_POST['dm_ns_2']) && ($_POST['dm_ns_2'] != "")) {
    ...
    if ($valid_code == 'true') {
        ...
        if (!preg_match("/RESULT: success/", $place_order)) {
            ...
            $subject = "create domain: " . $_POST['dm_domain'];
